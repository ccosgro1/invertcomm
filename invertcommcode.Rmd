...
write.csv(commdata,"invertcommdata.csv")
```
...
plot(commdata$Total~commdata$Habitat, xlab="Ecosystem", ylab="Average Ecosystem Sum")
...
#shapiro.test is super non-normal, sqrt transform
sqtot=sqrt(commdata$Total)
