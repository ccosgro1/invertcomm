...
```{r CCA}
## Date 1
fly.cca.d1=cca(date1[,8:155]~date1$TerrType)
anova(fly.cca.d1)
plot(fly.cca.d1)

## Date 2
fly.cca.d2=cca(date2[,8:155]~date2$TerrType)
anova(fly.cca.d2)
plot(fly.cca.d2)

## Date 3
fly.cca.d3=cca(date3[,8:155]~date3$TerrType)
anova(fly.cca.d3)
plot(fly.cca.d3)

## Date 4
fly.cca.d4=cca(date4[,8:155]~date4$TerrType)
anova(fly.cca.d4)
plot(fly.cca.d4)
```