...
#Gamma
gammadiv=with(date1, tapply(specnumber(date1[,5:205]),TerrType.x.x))
plot(gammadiv)
gamma2=with(date2, tapply(specnumber(date2[,5:205]),TerrType.x.x))
gamma3=with(date3, tapply(specnumber(date3[,5:205]),TerrType.x.x))
gamma4=with(date4, tapply(specnumber(date4[,5:205]),TerrType.x.x))
plot(gammadiv,gamma2,gamma3,gamma4)
#Beta
alpha1 <- with(date1, tapply(specnumber(date1[,5:205]), TerrType.x.x, mean))
alpha2 <- with(date2, tapply(specnumber(date2[,5:205]), TerrType.x.x, mean))
alpha3 <- with(date3, tapply(specnumber(date3[,5:205]), TerrType.x.x, mean))
alpha4 <- with(date4, tapply(specnumber(date4[,5:205]), TerrType.x.x, mean))
...
ubr1=specnumber(u1[5:205], MARGIN=1)
ubr2=specnumber(u2[5:205], MARGIN=1)
ubr3=specnumber(u3[5:205], MARGIN=1)
ubr4=specnumber(u4[5:205], MARGIN=1)
...
rbr1=specnumber(u1[5:205], MARGIN=1)
rbr2=specnumber(u2[5:205], MARGIN=1)
rbr3=specnumber(u3[5:205], MARGIN=1)
rbr4=specnumber(u4[5:205], MARGIN=1)
...
urr1=specnumber(u1[5:205], MARGIN=1)
urr2=specnumber(u2[5:205], MARGIN=1)
urr3=specnumber(u3[5:205], MARGIN=1)
urr4=specnumber(u4[5:205], MARGIN=1)
...
alldates=lme(halldates~TerrType.x.x*Date, random = ~ 1|Plot, data=pitfall.core)
anova(alldates)

sralldates=specnumber(pitfall.core[5:205], MARGIN=1)
datesall=lme(sralldates~TerrType.x.x*Date, random=~1|Plot, data=pitfall.core)
anova(datesall)

pitfall.edge=pitfall[pitfall$EP.x!="Trans",]
pitfall.edge=pitfall.edge[pitfall.edge$TerrType.x.x!="UR",]
dim(pitfall.edge)

halldates1=diversity(pitfall.edge[5:205], index="shannon")
alldates1=lme(halldates1~TerrType.x.x*Date, random = ~ 1|Plot, data=pitfall.edge)
anova(alldates1)

sralldates1=specnumber(pitfall.edge[5:205], MARGIN=1)
datesall1=lme(sralldates1~TerrType.x.x*Date, random=~1|Plot, data=pitfall.edge)
anova(datesall1)
summary(datesall1)

pitfall.edge$TerrType.x.x
colnames(pitfall)
pitfall$TerrType.x.x


colnames(pitfall)=pitfall[1,]
lme(Hdate1~TerrType.x.x+Plot, data=date1)
```