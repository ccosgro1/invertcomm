...
```{r Date 1}
#### Aranaea ####
aranaea.d1=date1[,c(1:4,5:25,206:283)]
#remove NAs.
...
##rda by soil
colnames(aranaea.d1)
hel.rda.fulsoil = rda(aranaea.d1[,7:25], aranaea.d1[,35:59])
anova(hel.rda.fulsoil)#AYO
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared

##Pitfall inverts by trees
hel.rda.fulsoil = rda(aranaea.d1[,7:25],aranaea.d1[,c(68:102)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
##Pitfall inverts by PCNM
colnames(aranaea.d1)
all.geog.dist=vegdist(aranaea.d1[,66:67],method="euclid")
all.pcnm1=pcnm(all.geog.dist)
all.pcnmvecs=all.pcnm1$vectors
# If you can get the PCNM library to run, you could do the line below to select only significantly structured PCNMs
...
##Pitfall inverts by trees
hel.rda.fulsoil = rda(aranaea.d1[,7:25],aranaea.d1[,68:102])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
names(tree.hel.all.pcnm)
# Now run step 1, global analysis
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,7:25], tree.hel.all.pcnm[,104:140])
anova(hel.rda.all.fulpcnm)
RsquareAdj(hel.rda.all.fulpcnm)
global.thresh=RsquareAdj(hel.rda.all.fulpcnm)$adj.r.squared
## Variance partitioning - Not needed because there's no pcnm effect
...
names(tree.hel.all.pcnm)
# Now run step 1, global analysis
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,7:25], tree.hel.all.pcnm[,104:127])
anova(hel.rda.all.fulpcnm)
RsquareAdj(hel.rda.all.fulpcnm)
global.thresh=RsquareAdj(hel.rda.all.fulpcnm)$adj.r.squared
...
##Just the variables forward selected
#hel.rda.fulsoil = rda(tree.hel.all.pcnm[,5:44], tree.hel.all.pcnm[,c(239,248)])
#anova(hel.rda.fulsoil)
#RsquareAdj(hel.rda.fulsoil)
#global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
.hel.rda.fulsoil = rda(tree.hel.all.pcnm[,5:37], tree.hel.all.pcnm[,119:134])
...
names(tree.hel.all.pcnm)
# Now run step 1, global analysis
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:37], tree.hel.all.pcnm[,116:159])
anova(hel.rda.all.fulpcnm)
RsquareAdj(hel.rda.all.fulpcnm)
global.thresh=RsquareAdj(hel.rda.all.fulpcnm)$adj.r.squared
