...
dim(pitfall)
ordersums=read.csv("C:/Users/crc31/dropbox/Jennings Invertebrates/Cosgrove pitfall inverts_ordsums.csv", header=T)
...
bug.colsums=apply(ordersums[,5:29],2,sum)
plot(rank(bug.colsums),bug.colsums, xlab="Invert species")

# Determining rank abundance within an order across the ecosystems
names(ordersums)[names(ordersums)=='ï..Site']<-'Plot'
orderrab=merge(ordersums,tree.hel, by="Plot")

aggregate(orderrab$Amphipoda, by=list(orderrab$ecosys), FUN='sum')

##separate out by ecosys so that I can figure out within ecosystem rank abundance.
orderrab.bot=orderrab[orderrab$ecosys=="B",]
bug.colsums=apply(orderrab.bot[,5:29],2,sum)
plot(rank(bug.colsums),bug.colsums, xlab="Invert species")

orderrab.dis=orderrab[orderrab$ecosys=="D",]
bug.colsums=apply(orderrab.dis[,5:29],2,sum)
plot(rank(bug.colsums),bug.colsums, xlab="Invert species")

orderrab.rip=orderrab[orderrab$ecosys=="R",]
bug.colsums=apply(orderrab.rip[,5:29],2,sum)
plot(rank(bug.colsums),bug.colsums, xlab="Invert species")

orderrab.upl=orderrab[orderrab$ecosys=="U",]
bug.colsums=apply(orderrab.upl[,5:29],2,sum)
plot(rank(bug.colsums),bug.colsums, xlab="Invert species")
```
...
###Pitter patter, let's get atter. Let's do that sweet sweet forward selection
##Forward selection
hel.rda.fulsoil.none = rda(tree.hel.all.pcnm[,5:24]~1)
hel.rda.fulsoil = rda(tree.hel.all.pcnm[,5:24], tree.hel.all.pcnm[,103:126])

hel.rda.fulsoil.full=rda(tree.hel.all.pcnm[,5:24]~tree.hel.all.pcnm$PCNM1+tree.hel.all.pcnm$PCNM2+tree.hel.all.pcnm$PCNM3+tree.hel.all.pcnm$PCNM4+tree.hel.all.pcnm$PCNM5+tree.hel.all.pcnm$PCNM6+tree.hel.all.pcnm$PCNM7+tree.hel.all.pcnm$PCNM8+tree.hel.all.pcnm$PCNM9+tree.hel.all.pcnm$PCNM10+tree.hel.all.pcnm$PCNM11+tree.hel.all.pcnm$PCNM12+tree.hel.all.pcnm$PCNM13+tree.hel.all.pcnm$PCNM14+tree.hel.all.pcnm$PCNM15+tree.hel.all.pcnm$PCNM16+tree.hel.all.pcnm$PCNM17+tree.hel.all.pcnm$PCNM18+tree.hel.all.pcnm$PCNM19+tree.hel.all.pcnm$PCNM20+tree.hel.all.pcnm$PCNM21+tree.hel.all.pcnm$PCNM22+tree.hel.all.pcnm$PCNM23+tree.hel.all.pcnm$PCNM24)

tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel

##Just the variables forward selected
hel.rda.fulsoil = rda(tree.hel.all.pcnm[,5:24], tree.hel.all.pcnm[,c(103,118,115,123,117,112)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
## Forward Selection
hel.rda.fulsoil.none = rda(tree.hel.all.pcnm[,5:44]~1)
.hel.rda.fulsoil = rda(tree.hel.all.pcnm[,5:44], tree.hel.all.pcnm[,123:159])
...
##Just the variables forward selected
hel.rda.fulsoil = rda(tree.hel.all.pcnm[,5:44], tree.hel.all.pcnm[,c(153,124,159,142,138,126,130,128,135,123,152,125,129)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
###Pitter patter, let's get atter. Let's do that sweet sweet forward selection
##Forward selection
hel.rda.fulsoil.none = rda(gastropoda.d1[,5:14]~1)
hel.rda.fulsoil = rda(gastropoda.d1[,5:14], gastropoda.d1[,57:91])

hel.rda.fulsoil.full=rda(gastropoda.d1[,5:14]~gastropoda.d1$ACERUB+gastropoda.d1$ACESAC+gastropoda.d1$ACESIL+gastropoda.d1$BETALL+gastropoda.d1$CARCAR+gastropoda.d1$CARCOR+gastropoda.d1$CARTOM+gastropoda.d1$CORFLO+gastropoda.d1$CRAPUN+gastropoda.d1$FAGAME+gastropoda.d1$FRAAME+gastropoda.d1$FRANIG+gastropoda.d1$HAMVIR+gastropoda.d1$LIRTUP+gastropoda.d1$MAGACU+gastropoda.d1$MALCOR+gastropoda.d1$NYSSYL+gastropoda.d1$OSTVIR+gastropoda.d1$PLAOCC+gastropoda.d1$POPDEL+gastropoda.d1$POPGRA+gastropoda.d1$PRUSER+gastropoda.d1$QUEALB+gastropoda.d1$QUEBIC+gastropoda.d1$QUEPAL+gastropoda.d1$QUERUB+gastropoda.d1$SALNIG+gastropoda.d1$SASALB+gastropoda.d1$TILAME+gastropoda.d1$TOXVER+gastropoda.d1$ULMAME+gastropoda.d1$ULMRUB+gastropoda.d1$ULMSP+gastropoda.d1$VIBLEN)

tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel

##Just the variables forward selected
hel.rda.fulsoil = rda(gastropoda.d1[,5:14], gastropoda.d1[,c(248:282)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
hel.rda.fulsoil = rda(hymenoptera.d1[,5:20], hymenoptera.d1[,30:54])
anova(hel.rda.fulsoil)#AYO
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared

##Pitfall inverts by trees
hel.rda.fulsoil = rda(hymenoptera.d1[,5:20],hymenoptera.d1[,c(63:97)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
names(tree.hel.all.pcnm)
# Now run step 1, global analysis
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:20], tree.hel.all.pcnm[,99:135])
anova(hel.rda.all.fulpcnm)
RsquareAdj(hel.rda.all.fulpcnm)
global.thresh=RsquareAdj(hel.rda.all.fulpcnm)$adj.r.squared

##INVERTS BY ECOSYSTEM
hel.rda.fulsoil = rda(hymenoptera.d1[,5:20]~hymenoptera.d1$TerrType)
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
##Pitfall inverts by trees
hel.rda.fulsoil = rda(hymenoptera.d1[,5:20],hymenoptera.d1[,63:97])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
names(tree.hel.all.pcnm)
# Now run step 1, global analysis
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:20], tree.hel.all.pcnm[,99:122])
anova(hel.rda.all.fulpcnm)
RsquareAdj(hel.rda.all.fulpcnm)
global.thresh=RsquareAdj(hel.rda.all.fulpcnm)$adj.r.squared
...
###Pitter patter, let's get atter. Let's do that sweet sweet forward selection
##Forward selection
hel.rda.fulsoil.none = rda(orthoptera.d1[,5:9]~1)
hel.rda.fulsoil = rda(orthoptera.d1[,5:9], orthoptera.d1[,19:34])

hel.rda.fulsoil.full=rda(orthoptera.d1[,5:9]~orthoptera.d1$Ptot_long+orthoptera.d1$Po_long+orthoptera.d1$pH_long+orthoptera.d1$moist_long+orthoptera.d1$ps1_long+orthoptera.d1$ps2_long+orthoptera.d1$percc_long+orthoptera.d1$cton_long+orthoptera.d1$Ptot_nug+orthoptera.d1$Po_nug+orthoptera.d1$pH_nug+orthoptera.d1$moist_nug+orthoptera.d1$ps1_nug+orthoptera.d1$ps2_nug+orthoptera.d1$percc_nug+orthoptera.d1$pomc_nug+orthoptera.d1$cton_nug+orthoptera.d1$Ptot_short+orthoptera.d1$Po_short+orthoptera.d1$pH_short+orthoptera.d1$moist_short+orthoptera.d1$ps1_short+orthoptera.d1$percc_short+orthoptera.d1$pomc_short+orthoptera.d1$cton_short)

tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel

##Just the variables forward selected
hel.rda.fulsoil = rda(orthoptera.d1[,5:9], orthoptera.d1[,c(39,38,19,32)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
##Just the variables forward selected
hel.rda.fulsoil = rda(orthoptera.d1[,5:9], orthoptera.d1[,c(36,22,28,36,25)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
hel.rda.fulsoil.full=rda(orthoptera.d1[,5:9]~orthoptera.d1$ACERUB+orthoptera.d1$ACESAC+orthoptera.d1$ACESIL+orthoptera.d1$BETALL+orthoptera.d1$CARCAR+orthoptera.d1$CARCOR+orthoptera.d1$CARTOM+orthoptera.d1$CORFLO+orthoptera.d1$CRAPUN+orthoptera.d1$FAGAME+orthoptera.d1$FRAAME+orthoptera.d1$FRANIG+orthoptera.d1$HAMVIR+orthoptera.d1$LIRTUP+orthoptera.d1$MAGACU+orthoptera.d1$MALCOR+orthoptera.d1$NYSSYL+orthoptera.d1$OSTVIR+orthoptera.d1$PLAOCC+orthoptera.d1$POPDEL+orthoptera.d1$POPGRA+orthoptera.d1$PRUSER+orthoptera.d1$QUEALB+orthoptera.d1$QUEBIC+orthoptera.d1$QUEPAL+orthoptera.d1$QUERUB+orthoptera.d1$SALNIG+orthoptera.d1$SASALB+orthoptera.d1$TILAME+orthoptera.d1$TOXVER+orthoptera.d1$ULMAME+orthoptera.d1$ULMRUB+orthoptera.d1$ULMSP+orthoptera.d1$VIBLEN)

tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel

##Just the variables forward selected
hel.rda.fulsoil = rda(orthoptera.d1[,5:9], orthoptera.d1[,c(248:282)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
###Pitter patter, let's get atter. Let's do that sweet sweet forward selection
##Forward selection
hel.rda.fulsoil.none = rda(collembola.d1[,5:37]~1)
hel.rda.fulsoil = rda(collembola.d1[,5:37],collembola.d1[,47:71])

hel.rda.fulsoil.full=rda(collembola.d1[,5:37]~collembola.d1$Ptot_long+collembola.d1$Po_long+collembola.d1$pH_long+collembola.d1$moist_long+collembola.d1$ps1_long+collembola.d1$ps2_long+collembola.d1$percc_long+collembola.d1$cton_long+collembola.d1$Ptot_nug+collembola.d1$Po_nug+collembola.d1$pH_nug+collembola.d1$moist_nug+collembola.d1$ps1_nug+collembola.d1$ps2_nug+collembola.d1$percc_nug+collembola.d1$pomc_nug+collembola.d1$cton_nug+collembola.d1$Ptot_short+collembola.d1$Po_short+collembola.d1$pH_short+collembola.d1$moist_short+collembola.d1$ps1_short+collembola.d1$percc_short+collembola.d1$pomc_short+collembola.d1$cton_short)

tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel

##Just the variables forward selected
hel.rda.fulsoil = rda(collembola.d1[,5:37], collembola.d1[,c(50,66)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
hel.rda.fulsoil.full=rda(collembola.d1[,5:37]~collembola.d1$ACERUB+collembola.d1$ACESAC+collembola.d1$ACESIL+collembola.d1$BETALL+collembola.d1$CARCAR+collembola.d1$CARCOR+collembola.d1$CARTOM+collembola.d1$CORFLO+collembola.d1$CRAPUN+collembola.d1$FAGAME+collembola.d1$FRAAME+collembola.d1$FRANIG+collembola.d1$HAMVIR+collembola.d1$LIRTUP+collembola.d1$MAGACU+collembola.d1$MALCOR+collembola.d1$NYSSYL+collembola.d1$OSTVIR+collembola.d1$PLAOCC+collembola.d1$POPDEL+collembola.d1$POPGRA+collembola.d1$PRUSER+collembola.d1$QUEALB+collembola.d1$QUEBIC+collembola.d1$QUEPAL+collembola.d1$QUERUB+collembola.d1$SALNIG+collembola.d1$SASALB+collembola.d1$TILAME+collembola.d1$TOXVER+collembola.d1$ULMAME+collembola.d1$ULMRUB+collembola.d1$ULMSP+collembola.d1$VIBLEN)

tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel

##Just the variables forward selected
hel.rda.fulsoil = rda(collembola.d1[,5:37], collembola.d1[,c(248:282)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
## Forward Selection
hel.rda.fulsoil.none = rda(tree.hel.all.pcnm[,5:37]~1)
.hel.rda.fulsoil = rda(tree.hel.all.pcnm[,5:37], tree.hel.all.pcnm[,116:139])

hel.rda.fulsoil.full=rda(tree.hel.all.pcnm[,5:37]~tree.hel.all.pcnm$PCNM1+tree.hel.all.pcnm$PCNM2+tree.hel.all.pcnm$PCNM3+tree.hel.all.pcnm$PCNM4+tree.hel.all.pcnm$PCNM5+tree.hel.all.pcnm$PCNM6+tree.hel.all.pcnm$PCNM7+tree.hel.all.pcnm$PCNM8+tree.hel.all.pcnm$PCNM9+tree.hel.all.pcnm$PCNM10+tree.hel.all.pcnm$PCNM11+tree.hel.all.pcnm$PCNM12+tree.hel.all.pcnm$PCNM13+tree.hel.all.pcnm$PCNM14+tree.hel.all.pcnm$PCNM15+tree.hel.all.pcnm$PCNM16)

tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel

##Just the variables forward selected
hel.rda.fulsoil = rda(tree.hel.all.pcnm[,5:37], tree.hel.all.pcnm[,c(121)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
###Pitter patter, let's get atter. Let's do that sweet sweet forward selection
##Forward selection
hel.rda.fulsoil.none = rda(coleoptera.d2[,5:44]~1)
hel.rda.fulsoil = rda(coleoptera.d2[,5:44], coleoptera.d2[,87:121])

hel.rda.fulsoil.full=rda(coleoptera.d2[,5:44]~coleoptera.d2$ACERUB+coleoptera.d2$ACESAC+coleoptera.d2$ACESIL+coleoptera.d2$BETALL+coleoptera.d2$CARCAR+coleoptera.d2$CARCOR+coleoptera.d2$CARTOM+coleoptera.d2$CORFLO+coleoptera.d2$CRAPUN+coleoptera.d2$FAGAME+coleoptera.d2$FRAAME+coleoptera.d2$FRANIG+coleoptera.d2$HAMVIR+coleoptera.d2$LIRTUP+coleoptera.d2$MAGACU+coleoptera.d2$MALCOR+coleoptera.d2$NYSSYL+coleoptera.d2$OSTVIR+coleoptera.d2$PLAOCC+coleoptera.d2$POPDEL+coleoptera.d2$POPGRA+coleoptera.d2$PRUSER+coleoptera.d2$QUEALB+coleoptera.d2$QUEBIC+coleoptera.d2$QUEPAL+coleoptera.d2$QUERUB+coleoptera.d2$SALNIG+coleoptera.d2$SASALB+coleoptera.d2$TILAME+coleoptera.d2$TOXVER+coleoptera.d2$ULMAME+coleoptera.d2$ULMRUB+coleoptera.d2$ULMSP+coleoptera.d2$VIBLEN)

tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel

##Just the variables forward selected
hel.rda.fulsoil = rda(coleoptera.d2[,5:44], coleoptera.d2[,c(248:282)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
##Just the variables forward selected
hel.rda.fulsoil = rda(tree.hel.all.pcnm[,5:29], tree.hel.all.pcnm[,c(138,111,113,136,128)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
## Forward Selection
hel.rda.fulsoil.none = rda(tree.hel.all.pcnm[,5:14]~1)
.hel.rda.fulsoil = rda(tree.hel.all.pcnm[,5:14], tree.hel.all.pcnm[,93:116])

hel.rda.fulsoil.full=rda(tree.hel.all.pcnm[,5:14]~tree.hel.all.pcnm$PCNM1+tree.hel.all.pcnm$PCNM2+tree.hel.all.pcnm$PCNM3+tree.hel.all.pcnm$PCNM4+tree.hel.all.pcnm$PCNM5+tree.hel.all.pcnm$PCNM6+tree.hel.all.pcnm$PCNM7+tree.hel.all.pcnm$PCNM8+tree.hel.all.pcnm$PCNM9+tree.hel.all.pcnm$PCNM10+tree.hel.all.pcnm$PCNM11+tree.hel.all.pcnm$PCNM12+tree.hel.all.pcnm$PCNM13+tree.hel.all.pcnm$PCNM14+tree.hel.all.pcnm$PCNM15+tree.hel.all.pcnm$PCNM16+tree.hel.all.pcnm$PCNM17+tree.hel.all.pcnm$PCNM18+tree.hel.all.pcnm$PCNM19+tree.hel.all.pcnm$PCNM20+tree.hel.all.pcnm$PCNM21+tree.hel.all.pcnm$PCNM22+tree.hel.all.pcnm$PCNM23+tree.hel.all.pcnm$PCNM24)

tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel

##Just the variables forward selected
hel.rda.fulsoil = rda(tree.hel.all.pcnm[,5:14], tree.hel.all.pcnm[,c(109,101,94)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
###Pitter patter, let's get atter. Let's do that sweet sweet forward selection
##Forward selection
hel.rda.fulsoil.none = rda(hemiptera.d2[,5:14]~1)
hel.rda.fulsoil = rda(hemiptera.d2[,5:14], hemiptera.d2[,57:91])

hel.rda.fulsoil.full=rda(hemiptera.d2[,5:14]~hemiptera.d2$ACERUB+hemiptera.d2$ACESAC+hemiptera.d2$ACESIL+hemiptera.d2$BETALL+hemiptera.d2$CARCAR+hemiptera.d2$CARCOR+hemiptera.d2$CARTOM+hemiptera.d2$CORFLO+hemiptera.d2$CRAPUN+hemiptera.d2$FAGAME+hemiptera.d2$FRAAME+hemiptera.d2$FRANIG+hemiptera.d2$HAMVIR+hemiptera.d2$LIRTUP+hemiptera.d2$MAGACU+hemiptera.d2$MALCOR+hemiptera.d2$NYSSYL+hemiptera.d2$OSTVIR+hemiptera.d2$PLAOCC+hemiptera.d2$POPDEL+hemiptera.d2$POPGRA+hemiptera.d2$PRUSER+hemiptera.d2$QUEALB+hemiptera.d2$QUEBIC+hemiptera.d2$QUEPAL+hemiptera.d2$QUERUB+hemiptera.d2$SALNIG+hemiptera.d2$SASALB+hemiptera.d2$TILAME+hemiptera.d2$TOXVER+hemiptera.d2$ULMAME+hemiptera.d2$ULMRUB+hemiptera.d2$ULMSP+hemiptera.d2$VIBLEN)

tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel

##Just the variables forward selected
hel.rda.fulsoil = rda(hemiptera.d2[,5:14], hemiptera.d2[,c(248:282)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
hel.rda.fulsoil = rda(hymenoptera.d2[,5:20], hymenoptera.d2[,30:54])
anova(hel.rda.fulsoil)#AYO
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared

##Pitfall inverts by trees
hel.rda.fulsoil = rda(hymenoptera.d2[,5:20],hymenoptera.d2[,c(63:97)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
names(tree.hel.all.pcnm)
# Now run step 1, global analysis
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:20], tree.hel.all.pcnm[,99:134])
anova(hel.rda.all.fulpcnm)
RsquareAdj(hel.rda.all.fulpcnm)
global.thresh=RsquareAdj(hel.rda.all.fulpcnm)$adj.r.squared

##INVERTS BY ECOSYSTEM
hel.rda.fulsoil = rda(hymenoptera.d2[,5:20]~hymenoptera.d2$TerrType)
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
##Pitfall inverts by trees
hel.rda.fulsoil = rda(hymenoptera.d2[,5:20],hymenoptera.d2[,63:97])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
###Pitter patter, let's get atter. Let's do that sweet sweet forward selection
##Forward selection
hel.rda.fulsoil.none = rda(collembola.d2[,5:37]~1)
hel.rda.fulsoil = rda(collembola.d2[,5:37],collembola.d2[,47:71])

hel.rda.fulsoil.full=rda(collembola.d2[,5:37]~collembola.d2$Ptot_long+collembola.d2$Po_long+collembola.d2$pH_long+collembola.d2$moist_long+collembola.d2$ps1_long+collembola.d2$ps2_long+collembola.d2$percc_long+collembola.d2$cton_long+collembola.d2$Ptot_nug+collembola.d2$Po_nug+collembola.d2$pH_nug+collembola.d2$moist_nug+collembola.d2$ps1_nug+collembola.d2$ps2_nug+collembola.d2$percc_nug+collembola.d2$pomc_nug+collembola.d2$cton_nug+collembola.d2$Ptot_short+collembola.d2$Po_short+collembola.d2$pH_short+collembola.d2$moist_short+collembola.d2$ps1_short+collembola.d2$percc_short+collembola.d2$pomc_short+collembola.d2$cton_short)

tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel

##Just the variables forward selected
hel.rda.fulsoil = rda(collembola.d2[,5:37], collembola.d2[,c(47,54,71,70)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
## Forward Selection
hel.rda.fulsoil.none = rda(tree.hel.all.pcnm[,5:44]~1)
.hel.rda.fulsoil = rda(tree.hel.all.pcnm[,5:44], tree.hel.all.pcnm[,123:147])
...
##Just the variables forward selected
hel.rda.fulsoil = rda(tree.hel.all.pcnm[,5:44], tree.hel.all.pcnm[,c(125)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
## Forward Selection
hel.rda.fulsoil.none = rda(tree.hel.all.pcnm[,5:7]~1)
.hel.rda.fulsoil = rda(tree.hel.all.pcnm[,5:7], tree.hel.all.pcnm[,86:123])

hel.rda.fulsoil.full=rda(tree.hel.all.pcnm[,5:7]~tree.hel.all.pcnm$PCNM1+tree.hel.all.pcnm$PCNM2+tree.hel.all.pcnm$PCNM3+tree.hel.all.pcnm$PCNM4+tree.hel.all.pcnm$PCNM5+tree.hel.all.pcnm$PCNM6+tree.hel.all.pcnm$PCNM7+tree.hel.all.pcnm$PCNM8+tree.hel.all.pcnm$PCNM9+tree.hel.all.pcnm$PCNM10+tree.hel.all.pcnm$PCNM11+tree.hel.all.pcnm$PCNM12+tree.hel.all.pcnm$PCNM13+tree.hel.all.pcnm$PCNM14+tree.hel.all.pcnm$PCNM15+tree.hel.all.pcnm$PCNM16+tree.hel.all.pcnm$PCNM17+tree.hel.all.pcnm$PCNM18+tree.hel.all.pcnm$PCNM19+tree.hel.all.pcnm$PCNM20+tree.hel.all.pcnm$PCNM21+tree.hel.all.pcnm$PCNM22+tree.hel.all.pcnm$PCNM23+tree.hel.all.pcnm$PCNM24+tree.hel.all.pcnm$PCNM25+tree.hel.all.pcnm$PCNM26+tree.hel.all.pcnm$PCNM27+tree.hel.all.pcnm$PCNM28+tree.hel.all.pcnm$PCNM29+tree.hel.all.pcnm$PCNM30+tree.hel.all.pcnm$PCNM31+tree.hel.all.pcnm$PCNM32+tree.hel.all.pcnm$PCNM33+tree.hel.all.pcnm$PCNM34+tree.hel.all.pcnm$PCNM35+tree.hel.all.pcnm$PCNM36+tree.hel.all.pcnm$PCNM37+tree.hel.all.pcnm$PCNM38)

tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel

##Just the variables forward selected
hel.rda.fulsoil = rda(tree.hel.all.pcnm[,5:7], tree.hel.all.pcnm[,c(118,87:88)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
## Forward Selection
hel.rda.fulsoil.none = rda(tree.hel.all.pcnm[,5:7]~1)
.hel.rda.fulsoil = rda(tree.hel.all.pcnm[,5:7], tree.hel.all.pcnm[,86:110])
...
##Just the variables forward selected
hel.rda.fulsoil = rda(tree.hel.all.pcnm[,5:7], tree.hel.all.pcnm[,c(109,90,88,108)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
###Pitter patter, let's get atter. Let's do that sweet sweet forward selection
##Forward selection
hel.rda.fulsoil.none = rda(diplopoda.d3[,5:9]~1)
hel.rda.fulsoil = rda(diplopoda.d3[,5:9], diplopoda.d3[,52:86])

hel.rda.fulsoil.full=rda(diplopoda.d3[,5:9]~diplopoda.d3$ACERUB+diplopoda.d3$ACESAC+diplopoda.d3$ACESIL+diplopoda.d3$BETALL+diplopoda.d3$CARCAR+diplopoda.d3$CARCOR+diplopoda.d3$CARTOM+diplopoda.d3$CORFLO+diplopoda.d3$CRAPUN+diplopoda.d3$FAGAME+diplopoda.d3$FRAAME+diplopoda.d3$FRANIG+diplopoda.d3$HAMVIR+diplopoda.d3$LIRTUP+diplopoda.d3$MAGACU+diplopoda.d3$MALCOR+diplopoda.d3$NYSSYL+diplopoda.d3$OSTVIR+diplopoda.d3$PLAOCC+diplopoda.d3$POPDEL+diplopoda.d3$POPGRA+diplopoda.d3$PRUSER+diplopoda.d3$QUEALB+diplopoda.d3$QUEBIC+diplopoda.d3$QUEPAL+diplopoda.d3$QUERUB+diplopoda.d3$SALNIG+diplopoda.d3$SASALB+diplopoda.d3$TILAME+diplopoda.d3$TOXVER+diplopoda.d3$ULMAME+diplopoda.d3$ULMRUB+diplopoda.d3$ULMSP+diplopoda.d3$VIBLEN)

tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel

##Just the variables forward selected
hel.rda.fulsoil = rda(diplopoda.d3[,5:9], diplopoda.d3[,c(248:282)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
names(tree.hel.all.pcnm)
# Now run step 1, global analysis
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:29], tree.hel.all.pcnm[,108:137])
anova(hel.rda.all.fulpcnm)
RsquareAdj(hel.rda.all.fulpcnm)
global.thresh=RsquareAdj(hel.rda.all.fulpcnm)$adj.r.squared
## Variance partitioning - Not needed because there's no pcnm effect
...
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared4

###Pitter patter, let's get atter. Let's do that sweet sweet forward selection
##Forward selection
hel.rda.fulsoil.none = rda(diptera.d3[,5:29]~1)
hel.rda.fulsoil = rda(diptera.d3[,5:29],diptera.d3[,39:63])

hel.rda.fulsoil.full=rda(diptera.d3[,5:29]~diptera.d3$Ptot_long+diptera.d3$Po_long+diptera.d3$pH_long+diptera.d3$moist_long+diptera.d3$ps1_long+diptera.d3$ps2_long+diptera.d3$percc_long+diptera.d3$cton_long+diptera.d3$Ptot_nug+diptera.d3$Po_nug+diptera.d3$pH_nug+diptera.d3$moist_nug+diptera.d3$ps1_nug+diptera.d3$ps2_nug+diptera.d3$percc_nug+diptera.d3$pomc_nug+diptera.d3$cton_nug+diptera.d3$Ptot_short+diptera.d3$Po_short+diptera.d3$pH_short+diptera.d3$moist_short+diptera.d3$ps1_short+diptera.d3$percc_short+diptera.d3$pomc_short+diptera.d3$cton_short)

tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel

##Just the variables forward selected
hel.rda.fulsoil = rda(diptera.d3[,5:29], diptera.d3[,c(62,68)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
## Forward Selection
hel.rda.fulsoil.none = rda(tree.hel.all.pcnm[,5:14]~1)
.hel.rda.fulsoil = rda(tree.hel.all.pcnm[,5:14], tree.hel.all.pcnm[,93:130])
...
##Just the variables forward selected
hel.rda.fulsoil = rda(tree.hel.all.pcnm[,5:14], tree.hel.all.pcnm[,c(118,87:88)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
##Just the variables forward selected
hel.rda.fulsoil = rda(tree.hel.all.pcnm[,5:14], tree.hel.all.pcnm[,c(128,105)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
###Pitter patter, let's get atter. Let's do that sweet sweet forward selection
##Forward selection
hel.rda.fulsoil.none = rda(hemiptera.d3[,5:14]~1)
hel.rda.fulsoil = rda(hemiptera.d3[,5:14], hemiptera.d3[,57:91])

hel.rda.fulsoil.full=rda(hemiptera.d3[,5:14]~hemiptera.d3$ACERUB+hemiptera.d3$ACESAC+hemiptera.d3$ACESIL+hemiptera.d3$BETALL+hemiptera.d3$CARCAR+hemiptera.d3$CARCOR+hemiptera.d3$CARTOM+hemiptera.d3$CORFLO+hemiptera.d3$CRAPUN+hemiptera.d3$FAGAME+hemiptera.d3$FRAAME+hemiptera.d3$FRANIG+hemiptera.d3$HAMVIR+hemiptera.d3$LIRTUP+hemiptera.d3$MAGACU+hemiptera.d3$MALCOR+hemiptera.d3$NYSSYL+hemiptera.d3$OSTVIR+hemiptera.d3$PLAOCC+hemiptera.d3$POPDEL+hemiptera.d3$POPGRA+hemiptera.d3$PRUSER+hemiptera.d3$QUEALB+hemiptera.d3$QUEBIC+hemiptera.d3$QUEPAL+hemiptera.d3$QUERUB+hemiptera.d3$SALNIG+hemiptera.d3$SASALB+hemiptera.d3$TILAME+hemiptera.d3$TOXVER+hemiptera.d3$ULMAME+hemiptera.d3$ULMRUB+hemiptera.d3$ULMSP+hemiptera.d3$VIBLEN)

tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel

##Just the variables forward selected
hel.rda.fulsoil = rda(hemiptera.d3[,5:14], hemiptera.d3[,c(248:282)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
hel.rda.fulsoil = rda(hymenoptera.d3[,5:20], hymenoptera.d3[,30:54])
anova(hel.rda.fulsoil)#AYO
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared

##Pitfall inverts by trees
hel.rda.fulsoil = rda(hymenoptera.d3[,5:20],hymenoptera.d3[,c(63:97)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
###Pitter patter, let's get atter. Let's do that sweet sweet forward selection
##Forward selection
hel.rda.fulsoil.none = rda(hymenoptera.d3[,5:14]~1)
hel.rda.fulsoil = rda(hymenoptera.d3[,5:14], hymenoptera.d3[,57:91])

hel.rda.fulsoil.full=rda(hymenoptera.d3[,5:14]~hymenoptera.d3$ACERUB+hymenoptera.d3$ACESAC+hymenoptera.d3$ACESIL+hymenoptera.d3$BETALL+hymenoptera.d3$CARCAR+hymenoptera.d3$CARCOR+hymenoptera.d3$CARTOM+hymenoptera.d3$CORFLO+hymenoptera.d3$CRAPUN+hymenoptera.d3$FAGAME+hymenoptera.d3$FRAAME+hymenoptera.d3$FRANIG+hymenoptera.d3$HAMVIR+hymenoptera.d3$LIRTUP+hymenoptera.d3$MAGACU+hymenoptera.d3$MALCOR+hymenoptera.d3$NYSSYL+hymenoptera.d3$OSTVIR+hymenoptera.d3$PLAOCC+hymenoptera.d3$POPDEL+hymenoptera.d3$POPGRA+hymenoptera.d3$PRUSER+hymenoptera.d3$QUEALB+hymenoptera.d3$QUEBIC+hymenoptera.d3$QUEPAL+hymenoptera.d3$QUERUB+hymenoptera.d3$SALNIG+hymenoptera.d3$SASALB+hymenoptera.d3$TILAME+hymenoptera.d3$TOXVER+hymenoptera.d3$ULMAME+hymenoptera.d3$ULMRUB+hymenoptera.d3$ULMSP+hymenoptera.d3$VIBLEN)

tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel

##Just the variables forward selected
hel.rda.fulsoil = rda(hymenoptera.d3[,5:14], hymenoptera.d3[,c(248:282)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
names(tree.hel.all.pcnm)
# Now run step 1, global analysis
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:20], tree.hel.all.pcnm[,99:136])
anova(hel.rda.all.fulpcnm)
RsquareAdj(hel.rda.all.fulpcnm)
global.thresh=RsquareAdj(hel.rda.all.fulpcnm)$adj.r.squared
...
##Pitfall inverts by trees
hel.rda.fulsoil = rda(hymenoptera.d3[,5:20],hymenoptera.d3[,63:97])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
##INVERTS BY ECOSYSTEM
hel.rda.fulsoil = rda(hymenoptera.d3[,5:20]~hymenoptera.d3$TerrType)
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
names(tree.hel.all.pcnm)
# Now run step 1, global analysis
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:20], tree.hel.all.pcnm[,99:123])
anova(hel.rda.all.fulpcnm)
RsquareAdj(hel.rda.all.fulpcnm)
global.thresh=RsquareAdj(hel.rda.all.fulpcnm)$adj.r.squared
...
###Pitter patter, let's get atter. Let's do that sweet sweet forward selection
##Forward selection
hel.rda.fulsoil.none = rda(collembola.d3[,5:37]~1)
hel.rda.fulsoil = rda(collembola.d3[,5:37],collembola.d3[,47:71])

hel.rda.fulsoil.full=rda(collembola.d3[,5:37]~collembola.d3$Ptot_long+collembola.d3$Po_long+collembola.d3$pH_long+collembola.d3$moist_long+collembola.d3$ps1_long+collembola.d3$ps2_long+collembola.d3$percc_long+collembola.d3$cton_long+collembola.d3$Ptot_nug+collembola.d3$Po_nug+collembola.d3$pH_nug+collembola.d3$moist_nug+collembola.d3$ps1_nug+collembola.d3$ps2_nug+collembola.d3$percc_nug+collembola.d3$pomc_nug+collembola.d3$cton_nug+collembola.d3$Ptot_short+collembola.d3$Po_short+collembola.d3$pH_short+collembola.d3$moist_short+collembola.d3$ps1_short+collembola.d3$percc_short+collembola.d3$pomc_short+collembola.d3$cton_short)

tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel

##Just the variables forward selected
hel.rda.fulsoil = rda(collembola.d3[,5:37], collembola.d3[,c(71,68,50)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
##Just the variables forward selected
hel.rda.fulsoil = rda(tree.hel.all.pcnm[,5:44], tree.hel.all.pcnm[,c(145,123,137,125,133,140,141)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
hel.rda.fulsoil = rda(hymenoptera.d4[,5:20], hymenoptera.d4[,30:54])
anova(hel.rda.fulsoil)#AYO
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared

##Pitfall inverts by trees
hel.rda.fulsoil = rda(hymenoptera.d4[,5:20],hymenoptera.d4[,c(63:97)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
##INVERTS BY ECOSYSTEM
hel.rda.fulsoil = rda(hymenoptera.d4[,5:20]~hymenoptera.d4$TerrType)
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
##Pitfall inverts by trees
hel.rda.fulsoil = rda(hymenoptera.d4[,5:20],hymenoptera.d4[,63:97])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
dim(date1)
Hdate1=diversity(date1.2[1:89,5:205])
raredate1=rarefy(date1[,5:205], 2)-1
specno=specnumber(date1.2[5:205], MARGIN=1)
...
boxplot(hr1, hr2, hr3, hr4, ylab="Shannon's Diversity",main="Riparian", ylim=c(1,3.5))
mtext(side=1,at=1,"26 Sept 2015",las=0,line=1, srt=45)
mtext(side=1,at=2,"24 May 2016",las=0,line=1)
mtext(side=1,at=3,"28 July 2018",las=0,line=1)
mtext(side=1,at=4,"15 Oct 2016",las=0,line=1)
...
boxplot(srr1,srr2,srr3,srr4, ylab="Taxonomic Richness", xlab="Date", ylim=c(0,50))
mtext(side=1,at=1,"26 Sept 2015",las=0,line=1, srt=45)
mtext(side=1,at=2,"24 May 2016",las=0,line=1)
mtext(side=1,at=3,"28 July 2018",las=0,line=1)
mtext(side=1,at=4,"15 Oct 2016",las=0,line=1)
...
boxplot(hu1, hu2, hu3, hu4, main="Upland", ylim=c(1,3.5))
mtext(side=1,at=1,"All Dates",las=2,line=1, srt=45)
mtext(side=1,at=2,"26 Sept 2015",las=2,line=1, srt=45)
mtext(side=1,at=3,"24 May 2016",las=2,line=1)
mtext(side=1,at=4,"28 July 2018",las=2,line=1)
...
boxplot(sru1,sru2,sru3,sru4, xlab="Date", ylab="", ylim=c(0,50))
mtext(side=1,at=1,"26 Sept 2015",las=0,line=1, srt=45)
mtext(side=1,at=2,"24 May 2016",las=0,line=1)
mtext(side=1,at=3,"28 July 2018",las=0,line=1)
mtext(side=1,at=4,"15 Oct 2016",las=0,line=1)
...
boxplot(urd1, urd2, urd3, urd4, xlab="", ylab="", ylim=c(1,3.5), main="Riparian-Upland")
mtext(side=1,at=1,"26 Sept 2015",las=0,line=1, srt=45)
mtext(side=1,at=2,"24 May 2016",las=0,line=1)
mtext(side=1,at=3,"28 July 2018",las=0,line=1)
mtext(side=1,at=4,"15 Oct 2016",las=0,line=1)
...
srripupl=boxplot(urr1, urr2, urr3, urr4, xlab="Date", ylab="", ylim=c(0,50))
mtext(side=1,at=1,"26 Sept 2015",las=0,line=1, srt=45)
mtext(side=1,at=2,"24 May 2016",las=0,line=1)
mtext(side=1,at=3,"28 July 2018",las=0,line=1)
mtext(side=1,at=4,"15 Oct 2016",las=0,line=1)
...
hel.rda.fulsoil = rda(tree.hel.soil[,5:17], tree.hel.soil[,27:51])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared

###INVERT BY TREE DATA
hel.rda.fulsoil = rda(tree.hel.soil[,5:17],tree.hel.soil[,c(60:94)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
colnames(tree.hel.soil)
all.geog.dist=vegdist(tree.hel.soil[,58:59],method="euclid")
all.pcnm1=pcnm(all.geog.dist)
all.pcnmvecs=all.pcnm1$vectors
# If you can get the PCNM library to run, you could do the line below to select only significantly structured PCNMs
...
names(tree.hel.all.pcnm)
# Now run step 1, global analysis
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:17], tree.hel.all.pcnm[,96:137])
anova(hel.rda.all.fulpcnm)
RsquareAdj(hel.rda.all.fulpcnm)
global.thresh=RsquareAdj(hel.rda.all.fulpcnm)$adj.r.squared
...
hel.rda.all.pcnm.none=rda(tree.hel.all.pcnm[,5:17]~1)
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:17], tree.hel.all.pcnm[,97:138])

hel.rda.all.pcnm.full=rda(tree.hel.all.pcnm[,5:17]~tree.hel.all.pcnm$PCNM1+tree.hel.all.pcnm$PCNM2+tree.hel.all.pcnm$PCNM3+tree.hel.all.pcnm$PCNM4+tree.hel.all.pcnm$PCNM5+tree.hel.all.pcnm$PCNM6+tree.hel.all.pcnm$PCNM7+tree.hel.all.pcnm$PCNM8+tree.hel.all.pcnm$PCNM9+tree.hel.all.pcnm$PCNM10+tree.hel.all.pcnm$PCNM11+tree.hel.all.pcnm$PCNM12+tree.hel.all.pcnm$PCNM13+tree.hel.all.pcnm$PCNM14+tree.hel.all.pcnm$PCNM15+tree.hel.all.pcnm$PCNM16+tree.hel.all.pcnm$PCNM17+tree.hel.all.pcnm$PCNM18+tree.hel.all.pcnm$PCNM19+tree.hel.all.pcnm$PCNM20+tree.hel.all.pcnm$PCNM21+tree.hel.all.pcnm$PCNM22+tree.hel.all.pcnm$PCNM23+tree.hel.all.pcnm$PCNM24+tree.hel.all.pcnm$PCNM25+tree.hel.all.pcnm$PCNM26+tree.hel.all.pcnm$PCNM27+tree.hel.all.pcnm$PCNM28+tree.hel.all.pcnm$PCNM29+tree.hel.all.pcnm$PCNM30+tree.hel.all.pcnm$PCNM31+tree.hel.all.pcnm$PCNM32+tree.hel.all.pcnm$PCNM33+tree.hel.all.pcnm$PCNM34+tree.hel.all.pcnm$PCNM35+tree.hel.all.pcnm$PCNM36+tree.hel.all.pcnm$PCNM37+tree.hel.all.pcnm$PCNM38+tree.hel.all.pcnm$PCNM39+tree.hel.all.pcnm$PCNM40+tree.hel.all.pcnm$PCNM41+tree.hel.all.pcnm$PCNM42)

tree.sel=ordiR2step(hel.rda.all.pcnm.none,scope=formula(hel.rda.all.pcnm.full),Pin=0.05,R2scope=TRUE)
tree.sel

##Just the variables forward selected
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:17], tree.hel.all.pcnm[,c(102,98,133,100,136,120,107)])
anova(hel.rda.all.fulpcnm)
RsquareAdj(hel.rda.all.fulpcnm)
global.thresh=RsquareAdj(hel.rda.all.fulpcnm)$adj.r.squared

##INVERTS BY ECOSYSTEM
hel.rda.fulsoil = rda(tree.hel.soil[,5:17]~tree.hel.soil$ecosys)
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
names(tree.hel.all.pcnm)
# Now run step 1, global analysis
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:17], tree.hel.all.pcnm[,96:132])
anova(hel.rda.all.fulpcnm)
RsquareAdj(hel.rda.all.fulpcnm)
global.thresh=RsquareAdj(hel.rda.all.fulpcnm)$adj.r.squared
...
#forward selection for our PCNM variables
hel.rda.all.pcnm.none=rda(tree.hel.all.pcnm[,5:17]~1)
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:17], tree.hel.all.pcnm[,97:133])
...
##Just the variables forward selected
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:17], tree.hel.all.pcnm[,c(99,17,129,131)])
anova(hel.rda.all.fulpcnm)
RsquareAdj(hel.rda.all.fulpcnm)
global.thresh=RsquareAdj(hel.rda.all.fulpcnm)$adj.r.squared
...
##Forward selection
hel.rda.fulsoil.none = rda(tree.hel.soil[,5:17]~1)
hel.rda.fulsoil = rda(tree.hel.soil[,5:17], tree.hel.soil[,60:94])

hel.rda.fulsoil.full=rda(tree.hel.soil[,5:17]~tree.hel.soil$ACERUB+tree.hel.soil$ACESAC+tree.hel.soil$ACESIL+tree.hel.soil$BETALL+tree.hel.soil$CARCAR+tree.hel.soil$CARCOR+tree.hel.soil$CAROVA+tree.hel.soil$CARTOM+tree.hel.soil$CORFLO+tree.hel.soil$CRAPUN+tree.hel.soil$FAGAME+tree.hel.soil$FRAAME+tree.hel.soil$FRANIG+tree.hel.soil$HAMVIR+tree.hel.soil$LIRTUP+tree.hel.soil$MAGACU+tree.hel.soil$MALCOR+tree.hel.soil$NYSSYL+tree.hel.soil$OSTVIR+tree.hel.soil$PLAOCC+tree.hel.soil$POPDEL+tree.hel.soil$POPGRA+tree.hel.soil$PRUSER+tree.hel.soil$QUEALB+tree.hel.soil$QUERUB+tree.hel.soil$SALNIG+tree.hel.soil$SASALB+tree.hel.soil$TILAME+tree.hel.soil$TOXVER+tree.hel.soil$ULMAME+tree.hel.soil$ULMRUB+tree.hel.soil$ULMSP+tree.hel.soil$VIBLEN)

tree.sel=ordiR2step(hel.rda.fulsoil.none,scope=formula(hel.rda.fulsoil.full),Pin=0.05,R2scope=TRUE)
tree.sel

##Just the variables forward selected
hel.rda.fulsoil = rda(tree.hel.soil[,5:17], tree.hel.soil[,c(172,176)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
names(tree.hel.all.pcnm)
# Now run step 1, global analysis
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:17], tree.hel.all.pcnm[,96:113])
anova(hel.rda.all.fulpcnm)
RsquareAdj(hel.rda.all.fulpcnm)
global.thresh=RsquareAdj(hel.rda.all.fulpcnm)$adj.r.squared
# now run step 2, the selection part
...
#forward selection for our PCNM variables
hel.rda.all.pcnm.none=rda(tree.hel.all.pcnm[,5:17]~1)
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:17], tree.hel.all.pcnm[,119:142])
...
##Just the variables forward selected
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:17], tree.hel.all.pcnm[,c(124,119,141,142,134)])
anova(hel.rda.all.fulpcnm)
RsquareAdj(hel.rda.all.fulpcnm)
global.thresh=RsquareAdj(hel.rda.all.fulpcnm)$adj.r.squared
...
names(tree.hel.all.pcnm)
# Now run step 1, global analysis
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:17], tree.hel.all.pcnm[,96:135])
anova(hel.rda.all.fulpcnm)
RsquareAdj(hel.rda.all.fulpcnm)
global.thresh=RsquareAdj(hel.rda.all.fulpcnm)$adj.r.squared
# now run step 2, the selection part
...
names(tree.hel.all.pcnm)
# Now run step 1, global analysis
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:17], tree.hel.all.pcnm[96:125])
anova(hel.rda.all.fulpcnm)
RsquareAdj(hel.rda.all.fulpcnm)
global.thresh=RsquareAdj(hel.rda.all.fulpcnm)$adj.r.squared
...
##Just the variables forward selected
hel.rda.fulsoil = rda(tree.hel.soil[,5:17], tree.hel.soil[,c(74,81,98,97)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
##Just the variables forward selected
hel.rda.fulsoil = rda(tree.hel.soil[,5:17], tree.hel.soil[,c(53,74,71)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
names(tree.hel.all.pcnm)
# Now run step 1, global analysis
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:17], tree.hel.all.pcnm[,96:139])
anova(hel.rda.all.fulpcnm)
RsquareAdj(hel.rda.all.fulpcnm)
global.thresh=RsquareAdj(hel.rda.all.fulpcnm)$adj.r.squared
# now run step 2, the selection part
...
#forward selection for our PCNM variables
hel.rda.all.pcnm.none=rda(tree.hel.all.pcnm[,5:17]~1)
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:17], tree.hel.all.pcnm[,97:140])
...
##Just the variables forward selected
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:17], tree.hel.all.pcnm[,c(119)])
anova(hel.rda.all.fulpcnm)
RsquareAdj(hel.rda.all.fulpcnm)
global.thresh=RsquareAdj(hel.rda.all.fulpcnm)$adj.r.squared
# Now that we have these parsimonious models, NOW WE CAN PERFORM VARIANCE PARTITIONING!  Hurray!
varpart(tree.hel.all.pcnm[,5:17], tree.hel.all.pcnm[,c(53,74,71)], tree.hel.all.pcnm[,c(119)])
# The variance explained by soil variables and spatial structure clearly overlap. 
# It also appears that there is more independent spatial structure in the trees than independent structuring by soil.
# Are the soil variables significant after accounting for spatial structure, and vice versa?
# Let's see.
hel.rda.all.partpcnm=rda(tree.hel.all.pcnm[,10:43], tree.hel.all.pcnm[,c(53,74,71)], tree.hel.all.pcnm[,c(119)])
anova(hel.rda.all.partpcnm)
# Yes.
hel.rda.all.partsoil=rda(tree.hel.all.pcnm[,10:43], tree.hel.all.pcnm[,c(119)], tree.hel.all.pcnm[,c(53,74,71)])
anova(hel.rda.all.partsoil)
# Also yes.  But only by p-value; that is really not much variance explained anymore.
...
##Just the variables forward selected
hel.rda.fulsoil = rda(tree.hel.soil[,5:17], tree.hel.soil[,c(71,69)])
anova(hel.rda.fulsoil)
RsquareAdj(hel.rda.fulsoil)
global.thresh=RsquareAdj(hel.rda.fulsoil)$adj.r.squared
...
names(tree.hel.all.pcnm)
# Now run step 1, global analysis
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:17], tree.hel.all.pcnm[,96:133])
anova(hel.rda.all.fulpcnm)
RsquareAdj(hel.rda.all.fulpcnm)
global.thresh=RsquareAdj(hel.rda.all.fulpcnm)$adj.r.squared
...
#forward selection for our PCNM variables
hel.rda.all.pcnm.none=rda(tree.hel.all.pcnm[,5:17]~1)
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:17], tree.hel.all.pcnm[,97:127])
...
##Just the variables forward selected
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:17], tree.hel.all.pcnm[,c(122,105,98,96)])
anova(hel.rda.all.fulpcnm)
RsquareAdj(hel.rda.all.fulpcnm)
global.thresh=RsquareAdj(hel.rda.all.fulpcnm)$adj.r.squared

# Now that we have these parsimonious models, NOW WE CAN PERFORM VARIANCE PARTITIONING!  Hurray!
varpart(tree.hel.all.pcnm[,5:17], tree.hel.all.pcnm[,c(60:94)], tree.hel.all.pcnm[,c(122,105,98,96)])
# The variance explained by soil variables and spatial structure clearly overlap. 
# It also appears that there is more independent spatial structure in the trees than independent structuring by soil.
# Are the soil variables significant after accounting for spatial structure, and vice versa?
# Let's see.
hel.rda.all.partpcnm=rda(tree.hel.all.pcnm[,10:43], tree.hel.all.pcnm[,c(60:94)], tree.hel.all.pcnm[,c(122,105,98,96)])
anova(hel.rda.all.partpcnm)
# Yes.
hel.rda.all.partsoil=rda(tree.hel.all.pcnm[,10:43], tree.hel.all.pcnm[,c(122,105,98,96)], tree.hel.all.pcnm[,c(60:94)])
anova(hel.rda.all.partsoil)
# Also yes.  But only by p-value; that is really not much variance explained anymore.
...
names(tree.hel.all.pcnm)
# Now run step 1, global analysis
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:17], tree.hel.all.pcnm[,96:120])
anova(hel.rda.all.fulpcnm)
RsquareAdj(hel.rda.all.fulpcnm)
global.thresh=RsquareAdj(hel.rda.all.fulpcnm)$adj.r.squared
# now run step 2, the selection part
...
names(tree.hel.all.pcnm)
# Now run step 1, global analysis
hel.rda.all.fulpcnm=rda(tree.hel.all.pcnm[,5:17], tree.hel.all.pcnm[,96:138])
anova(hel.rda.all.fulpcnm)
RsquareAdj(hel.rda.all.fulpcnm)
global.thresh=RsquareAdj(hel.rda.all.fulpcnm)$adj.r.squared
# now run step 2, the selection part
