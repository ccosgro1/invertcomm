...
varpart(tree.hel.all.pcnm[,5:205], tree.hel.all.pcnm[,c(264,259)], tree.hel.all.pcnm[,c(249,240,230,232)])
## Check to see if it's significant when PCNM and soil come first.
hel.rda.all.partpcnm=rda(tree.hel.all.pcnm[,5:205], tree.hel.all.pcnm[,c(264,259)], tree.hel.all.pcnm[,c(249,240,230,232)])
anova(hel.rda.all.partpcnm)
# Yes.
hel.rda.all.partsoil=rda(tree.hel.all.pcnm[,5:205], tree.hel.all.pcnm[,c(249,240,230,232)], tree.hel.all.pcnm[,c(264,259)])
...
## Variance partitioning
varpart(tree.hel.all.pcnm[,5:205], tree.hel.all.pcnm[,c(239,248)], tree.hel.all.pcnm[,c(260,255,280,273)])
## Check to see if it's significant when PCNM and soil come first.
hel.rda.all.partpcnm=rda(tree.hel.all.pcnm[,5:205], tree.hel.all.pcnm[,c(260,255,280,273)], tree.hel.all.pcnm[,c(239,248)])
anova(hel.rda.all.partpcnm)
# Yes.
hel.rda.all.partsoil=rda(tree.hel.all.pcnm[,5:205], tree.hel.all.pcnm[,c(239,248)], tree.hel.all.pcnm[,c(260,255,280,273)])
anova(hel.rda.all.partsoil)
# No.
